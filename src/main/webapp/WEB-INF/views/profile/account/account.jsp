...
<head>
    ...
    <link rel="stylesheet" href="/kys/static/css/account.css">
...
<body>
            ...
            <div id="container">
                <article>
                    <section class="side-bar">
                        <a href="/kys/profile/account">
                        	<div class="side-bar-item clicked">
                            	<h3>프로필 편집</h3>
                        	</div>
                        </a>
                        <a href="/kys/profile/account/password">
                    ...
                    <section class="profile-box">
                        <form class="profile-box-form1" enctype="multipart/form-data">
                            ...
                            <div class="box-item-right">
                                <h1 class="profile-username">junil</h1>
                            ...
                            <div class="box-items">
                                ...
                                <div class="box-item-right">
                                    <div class="input-items">
                                        <input type="text" id="name" class="text-input" name="name" value="김준일">
    ...
    <script type="text/javascript" src="/kys/static/js/account.js"></script>
</body>
