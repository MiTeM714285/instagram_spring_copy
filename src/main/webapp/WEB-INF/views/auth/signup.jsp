...
<head>
    ...
    <link rel="stylesheet" href="/kys/static/css/signup.css">
            ...
            <div class="content-box">
                <div class="item-box">
                    <div class="item-group">
                        ...
                        <form action="/kys/auth/signup" method="post">
                    ...
                    <div class="item-group">
                        <p>계정이 있으신가요? <a href="/kys/auth/signin">로그인</a></p>
                    </div>
                    <div class="download-img">
                        <img src="/kys/static/images/download.png">
                    </div>
                </div>
            </div>
        </main>
    </section>
    <script src="/kys/static/js/signup.js"></script>
</body>
